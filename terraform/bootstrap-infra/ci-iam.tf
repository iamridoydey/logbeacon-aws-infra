...
module "logbeacon_app_ci_role" {
  ...
  oidc_wildcard_subjects = [
    "repo:${var.github_username}@${var.github_account_id}/logbeacon-app@${var.github_logbeacon_app_repo_id}:pull_request",
    "repo:${var.github_username}@${var.github_account_id}/logbeacon-app@${var.github_logbeacon_app_repo_id}:ref:refs/heads/main",
    "repo:${var.github_username}@${var.github_account_id}/logbeacon-app@${var.github_logbeacon_app_repo_id}:environment:app-release-production",
  ]
